                            ...
                            @if($paper->mcqs->count() !=  0)
                                <div class="my-2">
                                    ...
                                    @foreach ($paper->mcqs as $key => $mcq)
                                        ...
                                        <input type="checkbox" class="checkoption" name="mcq" value="{{$option->option}}" onclick="checkedOnClick(this);"> {{$option->option}} <br>
                                        @endforeach
                                    @endforeach
                                </div>
                            @endif    
                                ...
                                <div class="my-3">
                                    ...
                                    @foreach ($paper->trueFalseQuestions as $key => $tf)
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="trueFalse" value="true" id="tf">
                                            <label class="form-check-label" for="tf">
                                              True
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="trueFalse" value="true" id="tf1" checked>
                            ...
                            @if($paper->subjectives->count() !=  0)    
                                <div class="my-3">
                                    ...
                                    @foreach ($paper->subjectives as $key => $subjective)
                                        ...
                                        <textarea name="subjective" rows="2" cols="50" maxlength="200">
